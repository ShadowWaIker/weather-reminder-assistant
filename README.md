...
### 早上7:00-16:00 (工作时间)
- **策略**: 检查未来6小时内的降水情况
- **适用场景**: 需要了解当天近期天气变化，及时做好出行准备
- **通知示例**: "预计下午2点开始小雨，请携带雨具"

### 下午16:00-21:00 (傍晚时间)
- **策略**: 检查第二天是否有降水
- **适用场景**: 提前了解次日天气，安排第二天的活动计划
- **通知示例**: "明天预计全天小雨，请提前准备雨具安排"

### 晚上21:00-7:00 (休息时间)
- **策略**: 不进行天气检查，避免夜间打扰
- **适用场景**: 保证夜间休息质量，避免不必要的通知
- **日志**: 记录"跳过检查（休息时间）"
...
示例日志：
```
2024/12/11 15:30:00 当前时间 15:30，使用6小时内检查策略
2024/12/11 15:30:00 检查时间: 2024-12-11T18:00+08:00, 相差: 2h30m0s
2024/12/11 15:30:00 进入检查区间: 2024-12-11T18:00+08:00, 天气: 小雨, 降水量: 2.5mm
2024/12/11 15:30:00 检测到降水: 小雨, 降水量: 2.5mm
```
...
5. **分时段策略**: 程序会根据当前时间自动选择检查策略，无需手动干预
